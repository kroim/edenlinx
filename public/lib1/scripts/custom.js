...
//		jQuery('#file-upload-submit').click();
//	});
//});
function load_profile(event) {
	//var output = document.getElementById('business_img');
...
$(document).ready(function () {
	size_li = $("#myRatingLists li").size();
	x=2;
	$('#myRatingLists li:lt('+x+')').show();
	$('#ratingsLoadMore').click(function () {
		x= (x+5 <= size_li) ? x+5 : size_li;
		$('#myRatingLists li:lt('+x+')').show();
	});
	$('#ratingsShowLess').click(function () {
		x=(x-5<0) ? 2 : x-5;
