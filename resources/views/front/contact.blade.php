...
@section('content')
    <div class="main-search-container margin-bottom-60" data-background-image="{{asset('images/contactback.png')}}">
    </div>
    <div class="container">
            ...
            <div class="col-md-4">
                ...
                <div class="sidebar-textbox">
                    ...
                    <ul class="contact-details">
                        <li><i class="im im-icon-phone contact-icon"></i><a><p> 0414 415 545 </p></a></li>
                        <li><i class="im im-icon-email contact-icon"></i><a><p> info@tradelinx.com.au</p></a></li>
                    </ul>
                </div>
