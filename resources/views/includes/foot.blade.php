...
<script type="text/javascript" src="{{asset('lib1/scripts/jpanelmenu.min.js')}}"></script>
<script type="text/javascript" src="{{asset('lib1/scripts/chosen.min.js')}}"></script>
<script type="text/javascript" src="{{asset('lib1/scripts/slick.min.js')}}"></script>
<script type="text/javascript" src="{{asset('lib1/scripts/rangeslider.min.js')}}"></script>
<script type="text/javascript" src="{{asset('lib1/scripts/magnific-popup.min.js')}}"></script>
<script type="text/javascript" src="{{asset('lib1/scripts/waypoints.min.js')}}"></script>
<script type="text/javascript" src="{{asset('lib1/scripts/counterup.min.js')}}"></script>
<script type="text/javascript" src="{{asset('lib1/scripts/jquery-ui.min.js')}}"></script>
